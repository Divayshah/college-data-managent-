    ...
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
        ...
        <div class="container">
            <a class="navbar-brand" href="welcome.php">
                <h1 class="navtitle">RSK Group of Colleges</h1>  <!-- Navbar Title -->
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post"> <!-- making a form when it posted then check data and make the register proccess -->
                                <div class="form-group <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>">
                                    ...
                                    <input type="text" name="username" class="form-control" value="<?php echo $username; ?>" aria-describedby="Username" placeholder="Enter College Username"> <!-- The user input that we take the value from it -->
                                ...
                                <div class="form-group <?php echo (!empty($name_err)) ? 'has-error' : ''; ?>">
                                    ...
                                    <input type="text" name="name" class="form-control" value="<?php echo $name; ?>" placeholder="Enter College Name">    <!-- The College Name that we take the value  -->
                                ...
                                <div class="form-group <?php echo (!empty($email_err)) ? 'has-error' : ''; ?>"> 
                                    ...
                                    <input type="text" name="email" class="form-control" value="<?php echo $email; ?>" placeholder="Enter College Email"> <!-- show a error to email  if there is any kind of errors in email  -->
                                ...
                                <div class="form-group <?php echo (!empty($address_err)) ? 'has-error' : ''; ?>">
                                    ...
                                    <input type="text" name="address" class="form-control" value="<?php echo $address; ?>" placeholder="Enter College Address"> <!-- show a error to address  if there is any kind of errors in address -->
                                ...
                                <div class="form-group <?php echo (!empty($number_err)) ? 'has-error' : ''; ?>">
                                    ...
                                    <input type="text" name="number" class="form-control" value="<?php echo $number; ?>" placeholder="Enter College Phone Number"> <!-- show a error to phone number  if there is any kind of errors in phone number  -->
